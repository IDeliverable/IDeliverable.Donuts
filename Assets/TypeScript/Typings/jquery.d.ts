...
interface JQueryAjaxSettings {
    ...
    isLocal?: boolean;
    /**
     * Override the callback function term in a jsonp request. This value will be used instead of 'callback' in the 'callback=?' part of the query string in the url. So {jsonp:'onJSONPLoad'} would result in 'onJSONPLoad=?' passed to the server. As of jQuery 1.5, setting the jsonp option to false prevents jQuery from adding the "?callback" string to the URL or attempting to use "=?" for transformation. In this case, you should also explicitly set the jsonpCallback setting. For example, { jsonp: false, jsonpCallback: "callbackName" }
     */
    jsonp?: any;
    /**
     * Specify the callback function term for a JSONP request. This value will be used instead of the random term automatically generated by jQuery. It is preferable to let jQuery generate a unique term as it'll make it easier to manage the requests and provide callbacks and error handling. You may want to specify the callback when you want to enable better browser caching of GET requests. As of jQuery 1.5, you can also use a function for this setting, in which case the value of jsonpCallback is set to the return value of that function.
     */
    jsonpCallback?: any;
    /**
...
interface JQueryAnimationOptions { 
    ...
    /**
     * A Boolean indicating whether to place the animation in the effects queue. If false, the animation will begin immediately. As of jQuery 1.7, the queue option can also accept a string, in which case the animation is added to the queue represented by that string. When a custom queue term is used the animation does not automatically start; you must call .dequeue("queuename") to start it.
     */
    queue?: any; 
    /**
...
interface JQueryStatic {
    ...
    /**
     * Returns value at named data store for the element, as set by jQuery.data(element, term, value), or the full data store for the element.
     *
     * @param element The DOM element to associate with the data.
     * @param key A string naming the piece of data to set.
     */
     ...
     * @param queueName A string containing the term of the queue. Defaults to fx, the standard effects queue.
     */
     ...
     * @param term A string naming the piece of data to remove.
     */
     ...
     *
     * @param context The object to which the context (this) of the function should be set.
     * @param term The term of the function whose context will be changed (should be a property of the context object).
     * @param additionalArguments Any number of arguments to be passed to the function named in the term argument.
     */
...
interface JQuery {
     ...
     * Adds the specified class(es) to each of the set of matched elements.
     *
     * @param function A function returning one or more space-separated class names to be added to the existing class term(s). Receives the index position of the element in the set and the existing class term(s) as arguments. Within the function, this refers to the current element in the set.
     */
     ...
     *
     * @param attributeName The term of the attribute to get.
     */
    attr(attributeName: string): string;
    /**
     * Set one or more attributes for the set of matched elements.
     *
     * @param attributeName The term of the attribute to set.
     ...
     *
     * @param className The class term to search for.
     */
     ...
     *
     * @param propertyName The term of the property to get.
     */
    prop(propertyName: string): any;
    /**
     * Set one or more properties for the set of matched elements.
     *
     * @param propertyName The term of the property to set.
     ...
     *
     * @param propertyName The term of the property to remove.
     */
     ...
     *
     * @param propertyName A CSS property term.
     * @param value A value to set for the property.
     */
    ...
    /**
     * Return the value at the named data store for the first element in the jQuery collection, as set by data(term, value) or by an HTML5 data-* attribute.
     *
     ...
     * Remove a previously-stored piece of data.
     *
     * @param term A string naming the piece of data to delete or space-separated string naming the pieces of data to delete.
     */
     ...
     *
     * @param queue The term of the queue in which to stop animations.
     */
    ...
    */
     ...
     * 
     * @param elements An array of elements to push onto the stack and make into a new jQuery object.
     * @param term The term of a jQuery method that generated the array of elements.
